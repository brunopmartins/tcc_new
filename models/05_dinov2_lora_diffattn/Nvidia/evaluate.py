#!/usr/bin/env python3
"""Model 05 — Nvidia CUDA full evaluation (mirror of AMD/evaluate.py)."""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Evaluate Model 05 (Nvidia CUDA)")
...
def build_model(ckpt):
    ...
    return DINOv2LoRAKinship(
        ...
        lora_rank=cfg.get("lora_rank", 8), lora_alpha=cfg.get("lora_alpha", 16),
        lora_dropout=cfg.get("lora_dropout", 0.0),
        backbone_pretrained=True, use_gradient_checkpointing=False,
...
def main() -> None:
    ...
    if args.full_analysis:
        ...
        plt.xlabel("FPR"); plt.ylabel("TPR"); plt.title("ROC — Model 05 (CUDA)")
        ...
        plt.title("Confusion — Model 05 (CUDA)")
        plt.tight_layout()
