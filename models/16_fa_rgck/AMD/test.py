...
from model import build_fa_rgck_net as build_rgck_net  # noqa: E402  (M16 family-adversarial)
...
def main():
    ...
    model = build_rgck_net(
        ...
        num_families=model_config.get("num_families", 600),
        adv_hidden=model_config.get("adv_hidden", 256),
    )
