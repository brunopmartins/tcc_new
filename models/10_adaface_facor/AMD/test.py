#!/usr/bin/env python3
"""
AMD ROCm test script for Model 10 — AdaFace + FaCoR Cross-Attention.
...
def parse_args():
    parser = argparse.ArgumentParser(description="Test Model 10 (AMD ROCm)")
...
def main():
    ...
    print("\n" + "=" * 60)
    print("AMD ROCm Testing — Model 10: AdaFace + FaCoR")
    print("=" * 60)
    ...
    with open(output_dir / "test_metrics_rocm.txt", "w") as f:
        f.write("AMD ROCm Test Results — Model 10 (AdaFace-FaCoR)\n")
        f.write("=" * 50 + "\n")
