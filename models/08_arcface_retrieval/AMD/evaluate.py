#!/usr/bin/env python3
"""Model 08 — AMD ROCm full analysis (ArcFace + retrieval)."""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Evaluate Model 08 (AMD ROCm)")
...
def main() -> None:
    ...
    if args.full_analysis:
        ...
        plt.xlabel("FPR"); plt.ylabel("TPR"); plt.title("ROC — Model 08")
        ...
        plt.title("Confusion — Model 08"); plt.tight_layout()
        ...
        if per_rel:
            ...
            ax.set_ylim(0, 1)
            ax.set_title("Per-relation accuracy — Model 08")
