...
from model import build_rgck_lora_net, DEFAULT_REGIONS_224  # noqa: E402  (M14 LoRA)
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--lora_rank", type=int, default=16,
                   help="M14 LoRA rank for the AdaFace backbone adapters.")
    p.add_argument("--lora_alpha", type=int, default=16,
                   help="M14 LoRA alpha (scaling = alpha / rank).")
    p.add_argument("--lora_stage3_tail", action="store_true", default=False,
                   help="M14: also inject LoRA into body[43:46] (stage-3 tail).")
...
def main() -> None:
    ...
    # M14: LoRA-adapted backbone (frozen base + low-rank adapters on stage 4 +
    # output_layer). The unfreeze_* flags are intentionally NOT passed — M14
    # never unfreezes base backbone weights; only the injected LoRA adapters
    # and the RGCK head train.
    model = build_rgck_lora_net(
        ...
        lora_stage4=True,
        lora_stage3_tail=args.lora_stage3_tail,
    ...
    model_config = {
        ...
        "lora_stage3_tail": bool(args.lora_stage3_tail),
