...
Para aplicações em que falsos positivos têm custo alto, como forense, usa-se TAR@FAR, ou taxa de aceitação verdadeira em uma taxa fixa de falsa aceitação. Este trabalho reporta TAR@FAR em $0,1$ e em $0,01$, que correspondem respectivamente a um regime tolerante e a um regime estrito. Average Precision, por sua vez, integra precisão sobre a curva precisão-revocação e captura o desempenho médio em todos os regimes de limiar simultaneamente.
