...
Atenção cruzada, ou cross-attention, é uma variação da self-attention em que as consultas vêm de uma sequência e as chaves e valores vêm de outra. Em verificação de parentesco, isso permite calcular pesos de atenção entre os tokens de uma face e os tokens da outra. Em vez de comparar apenas dois embeddings globais, o modelo aprende quais partes de uma imagem devem ser relacionadas com quais partes da outra.
