...
O SAM, sigla em inglês para Style-based Age Manipulation \cite{alaluf2022sam}, é uma implementação dessa ideia baseada em StyleGAN. O método aprende um mapeamento entre o espaço latente do gerador e a idade alvo, e produz, a partir de uma única imagem, variantes do mesmo rosto em diferentes idades. Como linha de pesquisa parcialmente executada neste trabalho, foi formulado um esquema de invariância geracional baseado em três variantes etárias por face (criança, jovem e idosa) que poderia, em princípio, ser aplicado de forma uniforme aos modelos supervisionados. Na prática, apenas o Modelo 01 teve o SAM integrado ao pipeline, e mesmo nele apenas parte das execuções operou com o módulo ativo devido ao requisito de pesos pré-treinados específicos de cerca de 4,5 GB. Os Modelos 02, 05, 06 e 12 não usam síntese de idade, e a invariância geracional fica registrada como direção exploratória futura. A descrição completa do esquema e da sua aplicação parcial está no Capítulo~\ref{cap:Metodologia}.
