...
A diferença em relação à maioria dos trabalhos citados é metodológica. Em vez de propor um único modelo novo e compará-lo a resultados isolados da literatura, este trabalho aplica o mesmo protocolo de avaliação aos cinco modelos supervisionados, com limiar selecionado em validação e aplicado sem reajuste no teste. A avaliação complementar dos modelos multimodais sobre a tarefa multiclasse de classificação de relações é apresentada em separado, sem pretensão de comparação direta às métricas binárias.
