...
A literatura de verificação de parentesco facial cresceu bastante entre 2010 e 2025. O que começou como um problema marginal de visão computacional virou um campo com benchmark próprio, competições anuais e dezenas de modelos competindo, do primeiro classificador baseado em atributos manuais aos modelos com Vision Transformer e atenção cruzada entre faces. Os modelos multimodais aparecem ao final como baselines complementares.
