...
A sequência mostra que o AdaFace-Regional depende principalmente de duas mudanças. A primeira é o descongelamento parcial: com AdaFace congelado, o modelo fica em AUC 0,746, enquanto o descongelamento parcial sobe para 0,856 ao liberar o último estágio e a camada de saída. A segunda é a passagem simétrica, que processa cada par nas duas ordens, $(A,B)$ e $(B,A)$, e reduz atalhos dependentes da posição das imagens. Essa mudança aumenta o AUC no ciclo de desenvolvimento em 0,022 sobre o descongelamento parcial e reduz o gap validação-teste de -0,076 para -0,026.
