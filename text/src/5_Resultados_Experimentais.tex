...
Sob validação cruzada, o AdaFace-Regional é a melhor arquitetura avaliada em FIW. O resultado da configuração com Negativos Difíceis é 0,876 $\pm$ 0,003 AUC, acima do ViT-FaCoR (0,846 $\pm$ 0,004), do DINOv2-LoRA (0,822), da linha de base AdaFace-Cosseno (0,799), do Claude Sonnet binário zero-shot (0,789), do Modelo com Recuperação (0,776) e do Codex VLM binário zero-shot (0,624). A principal evidência do capítulo é, portanto, que a proposta baseada em AdaFace parcialmente descongelado, tokens regionais anatômicos, cabeça auxiliar de relação e passagem simétrica melhora a verificação de parentesco no FIW em relação às alternativas avaliadas.
