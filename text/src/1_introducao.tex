...
\begin{enumerate}
  ...
  \item Implementar e avaliar uma proposta autoral para o Modelo 12, que combina AdaFace IR-101 com descongelamento parcial do último estágio, cinco tokens regionais anatômicos, atenção cruzada bidirecional entre regiões, gate sigmoide, cabeça auxiliar de relação e inferência simétrica entre as duas ordens do par.
